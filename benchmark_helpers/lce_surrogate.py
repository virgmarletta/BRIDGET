    ...
    def fit_hyperparam(
        ...
        for alpha in tqdm(alpha_grid):
            ...
            self.fit(
                ...
                scheduler = scheduler,
            )["system_acc"] #qui otteniamo chiami la self.fit del base method and take only the system acc 

            
            accuracy = compute_deferral_metrics(self.test(dataloader_val, log))["system_acc"]
        ...
        test_metrics = compute_deferral_metrics(self.test(dataloader_test, log))
